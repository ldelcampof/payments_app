...
public class MainActivity extends AppCompatActivity {
    ...
    public void openClientList(View view){
        final EditText salesman_number = (EditText) findViewById(R.id.salesman_id);

        String number = salesman_number.getText().toString();
        Intent intent = new Intent(this, ClientsActivity.class);
        intent.putExtra(EXTRA_salesman_id, number);
